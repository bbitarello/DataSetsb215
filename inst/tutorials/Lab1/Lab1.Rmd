...
-   Complete DataCamp assingments (All Introduction to R chapters) before next lab
...
2.  Use the R console (command-line)

3.  Use R as a calculator

4.  Understand the concepts of input and output in R
...
-   If you are trying to access the help function for a package that is
    not installed by default in R, you will need to add an extra "?"
...
Work on the DataCamp activities covering these data structures (All Chapters under the "Introduction to R" DataCamp course posted under DataCamp assignments).
