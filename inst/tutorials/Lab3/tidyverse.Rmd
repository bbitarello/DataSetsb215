...
1. Soft introduction to the `tidyverse` packages

2. Routine data wrangling tasks with `dplyr` core functions: `filter`, `select`, `mutate`, `arrange`, `summarise`

3. Pipe `%>%` these operations together.

4. The `ggplot2` package for plots
...
Recall we made a histogram of the titanic's passenger ages.
